...
def get_unet(img_rows, img_cols, flt=64, pool_size=(2, 2, 2), init_lr=1.0e-5):
    ...
    conv11 = Conv2D(flt,(1,1),activation='relu', padding='same')(inputs)
    ...
    conv22 = Conv2D(flt*2, (1,1),activation='relu', padding='same')(pool1)
    ...
    conv33 = Conv2D(flt*4,(1,1),activation='relu', padding='same')(pool2)
    ...
    conv44 = Conv2D(flt*8,(1,1),activation='relu', padding='same')(pool3)
    ...
    up6 = concatenate([Conv2DTranspose(flt*8, (2, 2), strides=(2, 2), padding='same')(conv5), Fconv4], axis=3)
    conv6 = Conv2D(flt*8, (3, 3), activation='relu', padding='same')(up6)
    conv6 = Conv2D(flt*4, (3, 3), activation='relu', padding='same')(conv6)

    up7 = concatenate([Conv2DTranspose(flt*4, (2, 2), strides=(2, 2), padding='same')(conv6), Fconv3], axis=3)
    conv7 = Conv2D(flt*4, (3, 3), activation='relu', padding='same')(up7)
    conv7 = Conv2D(flt*2, (3, 3), activation='relu', padding='same')(conv7)

    up8 = concatenate([Conv2DTranspose(flt*2, (2, 2), strides=(2, 2), padding='same')(conv7), Fconv2], axis=3)
    conv8 = Conv2D(flt*2, (3, 3), activation='relu', padding='same')(up8)
    conv8 = Conv2D(flt, (3, 3), activation='relu', padding='same')(conv8)

    up9 = concatenate([Conv2DTranspose(flt, (2, 2), strides=(2, 2), padding='same')(conv8), Fconv1], axis=3)
